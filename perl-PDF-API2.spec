...
Source0  : https://cpan.metacpan.org/authors/id/S/SS/SSIMMS/PDF-API2-2.045.tar.gz
...
%prep
%setup -q -n PDF-API2-2.045
cd %{_builddir}/PDF-API2-2.045
...
cp %{_builddir}/PDF-API2-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-PDF-API2/427011d005615027abd698deb63bd7fc3d444cbd || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-PDF-API2/427011d005615027abd698deb63bd7fc3d444cbd
